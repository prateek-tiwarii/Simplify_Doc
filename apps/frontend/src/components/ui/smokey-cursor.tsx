...
export default function SmokeyCursor({
  ...
  useEffect(() => {
    ...
    function generateColor(): ColorRGB {
      // Limit colors to: #737373 (115,115,115) and #f97316 (249,115,22)
      const palette: ColorRGB[] = [
        { r: 115 / 255, g: 115 / 255, b: 115 / 255 }, // gray
        { r: 249 / 255, g: 115 / 255, b: 22 / 255 },  // orange
      ];
      const base = palette[Math.floor(Math.random() * palette.length)];
      // Keep previous intensity scaling

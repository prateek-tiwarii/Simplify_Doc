  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        ...
        How Obligence Works: Your Contract, Smarter <br/>In <span className="tracking-tighter text-balance text-transparent from-primary/10 via-foreground/85 to-foreground/50 bg-linear-to-tl bg-clip-text">Four Simple Steps</span>
        </h2>
